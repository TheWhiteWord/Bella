...
- [RealtimeTTS FAQ](#realtimetts-faq)
  - [Table of Contents](#table-of-contents)
  - [Stream to Web Browser](#stream-to-web-browser)
  - [Use Voice Cloning](#use-voice-cloning)
  - [Use a Pretrained XTTS Model](#use-a-pretrained-xtts-model)
  - [Stuttering - What to Do](#stuttering---what-to-do)
  - [Use an UI like in the Showcase Video](#use-an-ui-like-in-the-showcase-video)
  - [Use it with a LLM](#use-it-with-a-llm)
  - [I get RuntimeError "freeze\_support"](#i-get-runtimeerror-freeze_support)
  - [Save the audio to file](#save-the-audio-to-file)
  - [I have probs running this on Linux/Unix](#i-have-probs-running-this-on-linuxunix)
  - [I want to use another output device](#i-want-to-use-another-output-device)
  - [Work with the realtime generated audiochunks](#work-with-the-realtime-generated-audiochunks)
  - [Use RealtimeTTS in another language](#use-realtimetts-in-another-language)
    - [Setting the language](#setting-the-language)
    - [Use of Tokenizers](#use-of-tokenizers)
      - [NLTK Tokenizer](#nltk-tokenizer)
      - [Stanza Tokenizer](#stanza-tokenizer)
      - [Choosing the Right Tokenizer](#choosing-the-right-tokenizer)
  - [How to use voices](#how-to-use-voices)
    - [Retrieve voices](#retrieve-voices)
    - [Set voices](#set-voices)
  - [Script won't terminate](#script-wont-terminate)
